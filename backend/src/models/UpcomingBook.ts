...
const upcomingBookSchema = new Schema<IUpcomingBook>(
  {
    ...
    coverImage: {
      type: String,
      default: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&w=400&h=600&q=80',
    },
    authorId: {
    ...
    status: {
      type: String,
      enum: ['ANNOUNCED', 'COMING_SOON', 'RELEASED', 'CANCELLED'],
      default: 'ANNOUNCED',
    },
    isFeatured: {
      type: Boolean,
